<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AttributeView.aspx.cs" Inherits="UserView_AttributeView" %>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Image ID="Image2" runat="server" ImageUrl='<%#Img(Eval("Img2")) %>' Width="150"
                                Height="100" />
                            <asp:Label ID="Label2" runat="server" Text='<%#(Eval("Attr2")) %>'></asp:Label><br />
                            <asp:Image ID="Image3" runat="server" ImageUrl='<%#Img(Eval("Img3")) %>' Width="150"
                                Height="100" />
                            <asp:Label ID="Label3" runat="server" Text='<%#(Eval("Attr3")) %>'></asp:Label>
                            <asp:Image ID="Image4" runat="server" ImageUrl='<%#Img(Eval("Img4")) %>' Width="150"
                                Height="100" />
                            <asp:Label ID="Label4" runat="server" Text='<%#(Eval("Attr4")) %>'></asp:Label><br />
